...
/**
 * Created by sunme on 03-03-2018.
 */

public class FullScreenVlcPlayer extends AppCompatActivity implements IVLCVout.Callback {

    public final static String TAG = "FULL";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fullscreen_vlc_player2);
    ...
    private void initView() {
        ...
        String fileName = "newmp4";
        String filePath = "android.resource://" + getPackageName() + "/raw/" + fileName;
//        mFilePath = "https://www.youtube.com/watch?v=O5WhLp366IQ";
        mFilePath = filePath;
//        mFilePath = "rtmp://rrbalancer.broadcast.tneg.de:1935/pw/ruk/ruk";
    ...
    private static class MyPlayerListener implements MediaPlayer.EventListener {
        ...
        public MyPlayerListener(FullScreenVlcPlayer owner) {
